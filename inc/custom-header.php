	...
	add_theme_support(
		...
		apply_filters(
			...
			array(
				...
				'height'             => 250,
				'flex-height'        => true,
				'wp-head-callback'   => 'wp_university_header_style',
			)
		)
	);
}
...
if ( ! function_exists( 'wp_university_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see wp_university_custom_header_setup().
	 */
	function wp_university_header_style() {
